...
public class DiscountCodeController {
    ...
    public ResponseEntity<List<DiscountCodeReadDto>> getDiscountCodes() {
        ...
        else return new ResponseEntity<>(HttpStatus.NOT_FOUND); //TODO maybe just return an empty list
    }
    ...
    public ResponseEntity<DiscountCodeReadDto> updateDiscountCode(@PathVariable("id") Long id,@Valid @RequestBody DiscountCodeCreateDto discountCodeCreateDto) {
